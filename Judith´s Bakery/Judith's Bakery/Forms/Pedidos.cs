...
namespace Judith_s_Bakery.Forms
{
    public partial class Pedidos : Form
    {
        ...
        public int traerIDpedido()
        {
            //Vamos a traer el Id, tomamos el ultimo valor agregado
            SqlCommand cmd = new SqlCommand("SELECT TOP 1 IdPedido FROM Pedidos ORDER BY IdPedido DESC", DataBase.Conexion());
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void Pedidos_KeyUp(object sender, KeyEventArgs e)
        {
